...
# --- WARNING FILTERS LOG DIAGNOSTICS CLEANUP ---
...
stationThresholds = {
    ...
    10: {24: 48.22, 48: 67.37, 72: 81.94, 120: 104.84, 168: 123.33, 240: 146.50},
    ...
    # Synchronized thresholds for Amalshid (Basin 13) to match the experimental probabilistic parameters
    13: {24: 20.00, 48: 39.00, 72: 60.00, 120: 76.00, 168: 116.00, 240: 134.00}
}
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not raw_date:
            ...
            try:
                ...
                self.stderr.write(self.style.ERROR(f"Invalid date argument received: {raw_date}"))
                return
    ...
    def compute_forecast_mean(self, stationGDF, station_name, given_date):
        forecast_dir = os.path.join(settings.BASE_DIR, "forecast", "ecmwf_0_2")
