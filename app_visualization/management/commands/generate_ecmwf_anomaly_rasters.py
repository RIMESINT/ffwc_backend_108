...
class Command(BaseCommand):
    help = 'Step 2: Generate GeoJSON maps and SVG legends for ECMWF Anomaly'
    ...
    def handle(self, *args, **kwargs):
        ...
        NC_FILE = os.path.join(BASE_PATH, f'ecmwf_rainfall_anomaly_{fdate}.nc')
        ...
        # Divergent Color Scale (Red = Dry, Blue = Wet)
        ...
        for i in tqdm(range(len(anomaly.time)), desc="Rasterizing ECMWF"):
            ...
            cb.set_label('ECMWF Rainfall Anomaly (mm/day)', fontsize=9, fontweight='bold')
        ...
        self.stdout.write(self.style.SUCCESS(f"✅ ECMWF Raster Assets Generated in: {BASE_PATH}"))