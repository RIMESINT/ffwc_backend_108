...
SYSTEM_STATE_NAME_IMD_WRF = app_visualization['system_state_name'][4]
...
class Command(BaseCommand):
    help = 'Processes IMD WRF daily cumulative data and performs weighted spatial grid averaging'
    ...
    def main(self, date_str):
        ...
        try:
            source_obj = Source.objects.get(name='IMD_WRF', source_type="basin_specific")
        except Source.DoesNotExist:
            self.stdout.write(self.style.ERROR("IMD_WRF source not found in database configuration mappings."))
            return
        ...
        with nco(nc_loc, 'r') as ncf:
            ...
            SystemState.objects.update_or_create(
                source=source_obj, name=SYSTEM_STATE_NAME_IMD_WRF,
