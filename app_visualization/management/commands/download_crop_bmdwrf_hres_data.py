	...
	def download_data(self, fdate, folder_path):
		...
		try:
			with yaspin(Spinners.dots, text="File Downloading...") as spinner:
				...
				remote_file_path = f"/RIMESNAS/WRF_OUT/wrf_out_{fdate}00.nc" #20240528
				...
				# os.rename(
				# 	f"{destination_directory}wrf_out_{fdate}00.nc", 
				# 	f"{destination_directory}wrf_out_{fdate}00_main.nc"
				# )
				# print(f"Chnaged file name wrf_out_{fdate}00.nc to wrf_out_{fdate}00_main.nc successfully.")
