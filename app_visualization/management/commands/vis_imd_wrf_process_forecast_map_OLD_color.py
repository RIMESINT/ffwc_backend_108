...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # my_dt = dt(2024, 5, 12, 0, 0, 0)
        # # Step 3: Convert to cftime.DatetimeProlepticGregorian
        # cftime_dt = cftime.DatetimeProlepticGregorian(
        #     my_dt.year, my_dt.month, my_dt.day, my_dt.hour, 
        #     my_dt.minute, my_dt.second, my_dt.microsecond, 
        #     has_year_zero=True
        # )
